...
def testear_distribucion(valores, nombre, media_teorica, varianza_teorica):
    ...
    _imprimir_resultados(nombre, media_teorica, varianza_teorica,
                          media_muestral, varianza_muestral)
    ...
    plt.axvline(media_teorica,  color='green', linestyle='--',
...
def testear_discreta(valores, nombre, media_teorica, varianza_teorica, probs_teoricas):
    ...
    ax.bar([i - ancho / 2 for i in x], obs, ancho,
           label='Frecuencia relativa observada', color='steelblue',
           alpha=0.8, edgecolor='black')
    ax.bar([i + ancho / 2 for i in x], esp, ancho,
           label='Probabilidad teórica', color='green',
           alpha=0.8, edgecolor='black')
...
if __name__ == "__main__":
    ...
    if distribucion == "uniforme":
        ...
        testear_discreta(valores, f"Poisson(λ={lam})",
                         media_teorica=lam,
                         varianza_teorica=lam,
                         probs_teoricas=probs)

    elif distribucion == "empirica":
        ...
        testear_discreta(valores, "Empírica Discreta",
                         media_teorica=ex,
                         varianza_teorica=vx,
                         probs_teoricas=probs)
